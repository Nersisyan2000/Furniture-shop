...
import 'package:furniture_shop/data/remote/auth_remote.dart' as _i14;
import 'package:furniture_shop/data/remote/auth_remote_impl.dart' as _i15;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i12.FavouriteCubit>(() => _i12.FavouriteCubit());
    gh.lazySingleton<_i13.ShoppingCubit>(() => _i13.ShoppingCubit());
    gh.factory<_i14.AuthRemote>(() => _i15.AuthRemoteImpl());
    return this;
  }
}
