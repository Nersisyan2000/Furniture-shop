...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/light_icon.svg
  SvgGenImage get lightIcon => const SvgGenImage('assets/icons/light_icon.svg');
  ...
  /// File path: assets/icons/notification_bell_icon.svg
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/logedUser.png
  AssetGenImage get logedUser => const AssetGenImage('assets/images/logedUser.png');
